...
public interface ClearCheckOut {
   ...
   */
  static void ClearCheckoutField(JTextField custName_fld, JTextField custNum_fld,
      JTextField checkInDate_fld, JTextField pricePerDay_fld, JTextField dayStay_fld,
      JTextField totalAmount_fld, JTextField email_fld, JComboBox<String> roomNum_fld,
      JTable table) {
